...
class DietsControllerTest < ActionController::TestCase
  ...
  test "should create diet" do
    assert_difference('Diet.count') do
      post :create, diet: { description: @diet.description, hospitalization_id: @diet.hospitalization_id }
    end
  ...
  test "should update diet" do
    patch :update, id: @diet, diet: { description: @diet.description, hospitalization_id: @diet.hospitalization_id }
    assert_redirected_to diet_path(assigns(:diet))
  end
