...
class PrescriptionsControllerTest < ActionController::TestCase
  ...
  test "should create prescription" do
    assert_difference('Prescription.count') do
      post :create, prescription: { calories: @prescription.calories, diet: @prescription.diet, quantity: @prescription.quantity, unit: @prescription.unit }
    end
  ...
  test "should update prescription" do
    patch :update, id: @prescription, prescription: { calories: @prescription.calories, diet: @prescription.diet, quantity: @prescription.quantity, unit: @prescription.unit }
    assert_redirected_to prescription_path(assigns(:prescription))
  end
